...
```{r ggplot_simple_geom_point, fig.height=5, fig.width=8}
pcPlot <- ggplot(data=patients_clean,
...
```
---
```{r, smooth_simple, fig.height=4.5, fig.width=8}
pcPlot <- ggplot(data=patients_clean,
        mapping=aes(x=Height,y=Weight))
...
```{r, histogram_simple, fig.height=4, fig.width=8,warning=FALSE}
pcPlot <- ggplot(data=patients_clean,
...
---
```{r, density_simple, fig.height=4.5, fig.width=8}
pcPlot <- ggplot(data=patients_clean,
        mapping=aes(x=Height))
...
```
---
```{r, violin_simple, fig.height=4.5, fig.width=8}
...
```{r, scatter_simple, fig.height=4, fig.width=4,tidy=FALSE}
pcPlot <- ggplot(data=patients_clean,
                 mapping=aes(x=Height,
                             y=Weight))
pcPlot+geom_point()
...
```{r, scatter_aes_sexShape, fig.height=4.5, fig.width=9,eval=F,echo=T}
pcPlot <- ggplot(data=patients_clean,
                 mapping=aes(x=Height,y=Weight,shape=Sex))
pcPlot+geom_point()
```

```{r, scatter_aes_sexShapeB, fig.height=4.5, fig.width=9,eval=T,echo=FALSE}
pcPlot <- ggplot(data=patients_clean,
                 mapping=aes(x=Height,y=Weight,shape=Sex))
...
```{r, facet_wrap_smokesBySexandPet, fig.height=4.5, fig.width=9}
pcPlot <- ggplot(data=patients_clean,aes(x=Height,y=Weight,
                                         colour=Sex))+geom_point()
...
```{r, facet_grid_smokesBySexandPet, fig.height=5, fig.width=9}
...
```{r, facet_grid_height_weight_BMIalpha, fig.height=4.5, fig.width=9}
pcPlot <- ggplot(data=patients_clean,
...
```{r, facet_grid_height_weight_BMIgradient2plus, fig.height=3.5, fig.width=9}
pcPlot <- ggplot(data=patients_clean,
                 aes(x=Height,y=Weight,colour=BMI))
pcPlot + geom_point(size=4,alpha=0.8) + 
...
```{r, theme_custom, fig.height=7, fig.width=9,tidy=FALSE}
...
```{r, theme_custom2, fig.height=3, fig.width=9,eval=FALSE}
...
```{r, theme_custom2.2, fig.height=3, fig.width=9,eval=TRUE,echo=FALSE}
...
```{r, theme_customMiniVsBW,echo=F,eval=T,collapse=FALSE,fig.height=3, fig.width=11,message=FALSE,warning=FALSE}
library(gridExtra)
p <- pcPlot+
  theme(text = element_text(colour="red"))
