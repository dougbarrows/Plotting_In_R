...
```{r,eval=TRUE,fig.width=8,fig.height=3.5,dpi=300,out.width="1000px",height="1080px"}
...
.pull-left[
```{r,eval=TRUE,fig.width=8,fig.height=4.5,dpi=300,out.width="1000px",height="1080px"}
...
```{r,eval=TRUE,collapse=TRUE,fig.width=8,fig.height=3.5,dpi=300,out.width="1000px",height="1080px"}
...
```{r,fig.width=8,fig.height=4.5,dpi=300,out.width="1000px",height="1080px"}
plot(treatment, type="o", col="blue", 
...
```{r,eval=TRUE,echo=FALSE,fig.width=8,fig.height=4,dpi=300,out.width="1000px",height="1080px"}
plot(treatment, type="o", col="blue", 
     ylim=g_range,axes=FALSE, ann=FALSE)
...
```{r,eval=TRUE,echo=FALSE,fig.height=3.5,dpi=300,out.width="1000px",height="1080px"}
plot(treatment, type="o", col="blue", 
     ylim=g_range,axes=FALSE, ann=FALSE)
axis(1, at=1:6, lab=c("Mon","Tue","Wed","Thu","Fri","Sat"))
...
```{r,eval=TRUE,echo=FALSE,fig.height=4,dpi=300,out.width="1000px",height="1080px"}
plot(treatment, type="o", col="blue", 
     ylim=g_range,axes=FALSE, ann=FALSE)
axis(1, at=1:6, lab=c("Mon","Tue","Wed","Thu","Fri","Sat"))
axis(2, las=1, at=20*0:g_range[2])
...
```{r,eval=TRUE,echo=FALSE,fig.width=8,fig.height=3.5,dpi=300,out.width="1920px",height="1080px"}
plot(treatment, type="o", col="blue", 
     ylim=g_range,axes=FALSE, ann=FALSE)
axis(1, at=1:6, lab=c("Mon","Tue","Wed","Thu","Fri","Sat"))
axis(2, las=1, at=20*0:g_range[2])
...
```{r,eval=TRUE,fig.width=8,fig.height=3.5,dpi=300,out.width="1920px",height="1080px"}
barplot(data$treatment,
        names.arg=c("Mon","Tue","Wed","Thu","Fri","Sat"))
```


---
Now we can plot data from a matrix with a stacked barchart. 
...
---
Now we can Graph data with adjacent bars using colors and place the legend at the top-left corner.
...
Similar cutomisation eixsts as for other plots.
```{r,eval=FALSE}
...
```{r,eval=T,fig.width=6,fig.height=3,dpi=300,out.width="1920px",height="1080px"}
