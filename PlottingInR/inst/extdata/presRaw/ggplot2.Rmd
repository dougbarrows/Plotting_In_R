...
```{r scaleCont_ggplot2, facet_grid_smokesBySex_scalex, fig.height=4, fig.width=9}
pcPlot <- ggplot(data=patients_clean,
...
```{r, line_eqn, fig.height=3, fig.width=7}
library(ggpubr)
...
```{r, line_eqn2, fig.height=4, fig.width=8}
...
```{r, marginal_ggplot, fig.height=3, fig.width=8, message = F, warning = F}
library(ggExtra)
pcPlot <- ggplot(data=patients_clean,
                 mapping=aes(x=Height,y=Weight,color=Sex)) + geom_point()
