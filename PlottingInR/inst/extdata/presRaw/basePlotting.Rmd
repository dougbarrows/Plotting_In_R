...
The [*batlow* package](https://cran.r-project.org/web/packages/khroma/vignettes/crameri.html) is a similarly derived collection of colors, with even more options like divergent palettes. 
...
```{r plot_heat ,fig.width=8,fig.height=3.5,dpi=300,out.width="1920px",height="1080px", echo=F}
...
First we cacluate the euler fit. Then we can plot it. 
